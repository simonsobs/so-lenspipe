...
def compute_n1mv(
    ...
    n1tt,n1ee,n1eb,n1te,n1tb=compute_n1_py(phifile,normarray,lensedcmbfile,cltt,clee,clbb,clte,noise_level,noisep,lmin,lmaxout,lmax_TT,lcorr_TT,tmp_output,Lstep,Lmin_out)
    n1ttee,n1tteb,n1ttte,n1tttb,n1eeeb,n1eete,n1eetb,n1ebte,n1ebtb,n1tetb=compute_n1mix(phifile,normarray,lensedcmbfile,cltt,clee,clbb,clte,noise_level,noisep,lmin,lmaxout,lmax_TT,lcorr_TT,tmp_output,Lstep,Lmin_out)
...
def compute_n0mv(
    ...
    n0tt,n0ee,n0eb,n0te,n0tb=compute_n0_py(phifile,lensedcmbfile,cltt,clee,clbb,clte,noise_level,noisep,lmin,lmaxout,lmax_TT,lcorr_TT,tmp_output,Lstep,Lmin_out)
