...
class LensingSandbox(object):
    def __init__(self,fwhm_arcmin,noise_uk,dec_min,dec_max,res, # simulation
        ...
        self.Als = pytempura.get_norms(ests, self.ucls, self.ucls, self.tcls, lmin, lmax) #for testing lmax in polarization
    ...
    def prepare(self,omap):
        ...
        ftalm,fealm,fbalm = futils.isotropic_filter(alm,self.tcls,self.lmin,self.lmax) ##adding new functionality. Use (pol_lmax_test branch in falafel)
