...
def is_lat_iso(qid):
    return (parse_qid_experiment(qid)=='so_lat_bn_may2025')
...
class SOLATBN_MAY2025_NoiseMetadata:
    def __init__(self, qid, verbose=False):
        self.qid = qid
    ...
    def read_in_sim(self,split_num, sim_num, lmax=5400, alm=True,  fwhm=2.2,  mask=None):
