...
"""
Here we calculate verify lensing reconstruction for shear without normalization
"""
...
with bench.show("QFUNC"):
    ...
    q_nobh_1 = solenspipe.get_qfunc(px,ucls,mlmax,e1,Al1=np.ones(2,4000),est2=None,Al2=None,R12=None)
...
def get_kmap(seed):
    ...
    return utils.shear_filter(dalm,ucls,tcls,lmin,lmax)
