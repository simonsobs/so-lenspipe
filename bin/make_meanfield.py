...
parser.add_argument("--nsims",     type=int,  default=200,help="nsims")
...
if rank==0:
    ...
    with bench.show("recon"):
        alm = hp.almxfl(solint.get_mv_kappa(polcomb,talm,ealm,balm)[0],al_mv)
    ...
    print(rmcls)
    np.savetxt(config['data_path']+"200hatfield_%s.txt"% polcomb,rmcls)
