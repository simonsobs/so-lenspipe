...
info = {
    ...
    'likelihood': {'my_cl_like': {"external": my_like, "requires": {'Cl': {'pp': 10000}}},'bao.sixdf_2011_bao':{},'bao.sdss_dr7_mgs':{},'bao.sdss_dr12_consensus_bao':{}},
    ...
    'modules': modules_path,
    'output': 'chainslensingBAO/lensing',
    'resume': True,}
