...
parser.add_argument("--isotropic", action='store_true',default=True,help='Isotropic sims.')
...
if rank==0:
    ...
    mf_alm = s.stacks['mf']
    t_alm,e_alm,b_alm = solint.get_kmap(channel,(0,0,0),lmin,lmax,filtered=True)
    recon_alms = qe.filter_alms(solint.get_mv_kappa(polcomb,t_alm,e_alm,b_alm),maps.interp(ils,Als[polcomb]))
    ...
    rcl=hp.alm2cl(recon_alms-mf_alm,recon_alms-mf_alm) / w4
